...
def deploy_flow(deployment_name, deployment_folder, chat_module):
    ...
    deployment = Deployment(
        ...
        environment_variables={
            'OPENAI_API_TYPE': "${{azureml://connections/azureai-development/metadata/ApiType}}",
            'OPENAI_API_BASE': "${{azureml://connections/azureai-development/target}}",
            'OPENAI_API_KEY': "${{azureml://connections/azureai-development/credentials/key}}",
            'OPENAI_API_VERSION': "${{azureml://connections/azureai-development/metadata/ApiVersion}}",
            'AZURE_AI_SEARCH_ENDPOINT': "${{azureml://connections/azureai-cogsearch/target}}",
            'AZURE_AI_SEARCH_KEY': "${{azureml://connections/azureai-cogsearch/credentials/key}}",
