...
```
ai search index update --files "../data/3-product-info/*.md" --index-name "contoso_product_index"
```
...
ai chat --question "which tent is the most waterproof?" --function copilot_aisdk/chat:chat_completion
```
